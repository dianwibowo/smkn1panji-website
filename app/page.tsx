...
function SectionLabel({ children }: { children: string }) {
  return (
    <p className="text-xs font-semibold tracking-[0.18em] uppercase text-blue-500 mb-3">
      {children}
    </p>
  )
}
...
export default function HomePage() {
  return (
    <div className="font-sans">
      ...
      {/* ── HERO ──────────────────────────────────────────────── */}
      <section className="relative min-h-[92vh] flex flex-col justify-end overflow-hidden bg-blue-950">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pb-20 pt-32 w-full">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[1.05] mb-6 max-w-4xl">
            ...
            belajar —{' '}
            <span className="text-blue-300 italic">berkarya.</span>
          </h1>
          <p className="text-blue-100/80 text-lg sm:text-xl max-w-2xl mb-10 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/profil/sejarah"
              className="bg-white text-blue-900 px-7 py-3.5 rounded-full font-semibold text-sm hover:bg-blue-50 transition-colors"
            >
              Kenali Kami
            </Link>
            <Link
      ...
      <section className="bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-blue-800">
            {stats.map((s) => (
              <div key={s.value} className="px-8 py-10">
                <div className="text-4xl font-bold leading-none mb-1">
                  {s.value}
                  {s.sublabel && (
                    <span className="text-xl ml-1 font-normal text-blue-300">{s.sublabel}</span>
                  )}
                </div>
                <div className="text-blue-300 text-sm mt-2 whitespace-pre-line leading-snug">
                  {s.label}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 leading-tight mb-6">
              ...
              <span className="text-blue-700 italic">Berkarakter</span>
            </h2>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-blue-100">
              <img
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-5 max-w-[220px]">
              <p className="text-3xl font-bold text-blue-900">Adiwiyata</p>
      ...
      <section className="bg-blue-50 py-24 px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="w-14 h-14 rounded-full bg-blue-200 overflow-hidden flex-shrink-0">
              <img
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900">
                12 Jurusan,{' '}
                <span className="text-blue-700 italic">satu tujuan.</span>
              </h2>
            </div>
            <Link
              href="/program-keahlian"
              className="text-blue-700 font-semibold hover:underline text-sm flex-shrink-0"
            >
              Lihat semua program →
            </Link>
          </div>
      ...
      <section className="py-24 px-6 lg:px-8 bg-gray-950 text-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="aspect-square rounded-xl bg-blue-900 overflow-hidden">
            ...
            <div className="aspect-square rounded-xl bg-blue-900 overflow-hidden mt-8">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold leading-tight mb-6">
              ...
              <span className="text-blue-300 italic">yang mendukung</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900">
                Terkini dari{' '}
                <span className="text-blue-700 italic">SMKN 1 Panji</span>
              </h2>
            </div>
            <Link href="/berita" className="text-blue-700 font-semibold hover:underline text-sm flex-shrink-0">
              Lihat semua berita →
            </Link>
          </div>
      ...
      {/* ── CTA PPDB ──────────────────────────────────────────── */}
      <section className="bg-blue-700 py-20 px-6 lg:px-8 text-white text-center">
